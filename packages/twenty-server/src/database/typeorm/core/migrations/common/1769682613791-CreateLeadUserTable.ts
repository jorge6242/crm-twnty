...
export class CreateLeadUserTable1769682613791 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "core"."lead_user_source_enum" AS ENUM('whatsapp', 'linkedin', 'email')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TYPE "core"."lead_user_source_enum"`);
    }
