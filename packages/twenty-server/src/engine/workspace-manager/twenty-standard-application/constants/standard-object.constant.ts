...
import {
    ...
    PERSON_JOB_HISTORY_STANDARD_FIELD_IDS,
...
export const STANDARD_OBJECTS = {
  ...
  company: {
    ...
    fields: {
      ...
      personJobHistories: {
        universalIdentifier: COMPANY_STANDARD_FIELD_IDS.personJobHistories,
      },
    },
    indexes: {
      accountOwnerIdIndex: {
  ...
  person: {
    ...
    fields: {
      ...
      jobHistory: {
        universalIdentifier: PERSON_STANDARD_FIELD_IDS.jobHistory,
      },
    },
    indexes: {
      companyIdIndex: {
  ...
  personJobHistory: {
    universalIdentifier: STANDARD_OBJECT_IDS.personJobHistory,
    fields: {
      id: { universalIdentifier: '20202020-4a1b-4001-8a01-8a9b0c1d2e3f' },
      createdAt: {
        universalIdentifier: '20202020-4a1b-4002-9b02-9aab0c1d2e3f',
      },
      updatedAt: {
        universalIdentifier: '20202020-4a1b-4003-8c03-0b1c2d3e4f5a',
      },
      deletedAt: {
        universalIdentifier: '20202020-4a1b-4004-9d04-1c2d3e4f5a6b',
      },
      jobTitle: {
        universalIdentifier: PERSON_JOB_HISTORY_STANDARD_FIELD_IDS.jobTitle,
      },
      startDate: {
        universalIdentifier: PERSON_JOB_HISTORY_STANDARD_FIELD_IDS.startDate,
      },
      endDate: {
        universalIdentifier: PERSON_JOB_HISTORY_STANDARD_FIELD_IDS.endDate,
      },
      isCurrent: {
        universalIdentifier: PERSON_JOB_HISTORY_STANDARD_FIELD_IDS.isCurrent,
      },
      source: {
        universalIdentifier: PERSON_JOB_HISTORY_STANDARD_FIELD_IDS.source,
      },
      person: {
        universalIdentifier: PERSON_JOB_HISTORY_STANDARD_FIELD_IDS.person,
      },
      company: {
        universalIdentifier: PERSON_JOB_HISTORY_STANDARD_FIELD_IDS.company,
      },
    },
    indexes: {},
    views: {},
