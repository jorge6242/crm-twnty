...
import { buildPersonJobHistoryStandardFlatFieldMetadatas } from 'src/engine/workspace-manager/twenty-standard-application/utils/field-metadata/compute-person-job-history-standard-flat-field-metadata.util';
...
const STANDARD_FLAT_FIELD_METADATA_BUILDERS_BY_OBJECT_NAME = {
  ...
  personJobHistory: buildPersonJobHistoryStandardFlatFieldMetadatas,
